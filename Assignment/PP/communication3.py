...
#server processer is an option that you can share with the main computer. It is actually always generated as a subprocess from the main and through the server you can "fork" the process 1
